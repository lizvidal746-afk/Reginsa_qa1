# ðŸŽ¯ INSTRUCCIONES PASO A PASO - TEST V2 OPTIMIZADO
...
## ðŸ“ PASO 2: REVISAR DOCUMENTACIÃ“N
...
## ðŸ“ PASO 4: EJECUTAR TEST

### ðŸš€ OPCIÃ“N 1: NPM (Recomendado)
...
### ðŸš€ OPCIÃ“N 2: PowerShell Script
...
### ðŸš€ OPCIÃ“N 4: Directo con Playwright
...
ðŸ” LOGIN Y NAVEGACIÃ“N
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
âœ… SesiÃ³n iniciada y mÃ³dulo cargado

â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
ðŸ“‹ PASO 2: ABRIENDO FORMULARIO
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
VerÃ¡s en consola:
```
âŒ SANCIÃ“N 3/5 no se marca correctamente
âŒ locator.click: Timeout 20000ms
âŒ Solo 2 sanciones registradas (se requieren al menos 3)
```
...
**Siguiente paso**: Ejecuta `npm run test:02-v2` y observa los resultados ðŸš€
