...
Write-Host ""
Write-Host "📊 ABRIENDO ALLURE REPORT" -ForegroundColor Cyan
...
if (-not (Test-Path "allure-results")) {
    Write-Host ""
    Write-Host "❌ ERROR: No hay datos de Allure" -ForegroundColor Red
    Write-Host ""
...
Write-Host ""
Write-Host "🔄 Iniciando Allure en http://localhost:4050..." -ForegroundColor Green
Write-Host ""
