/**
 * GRABACIÓN CODEGEN - TEST 2
 * 
 * Generado automáticamente por Playwright Codegen
 * Flujo: Registrar Sanción (completo)
 * 
 * ❌ NO USAR PARA TESTS REALES
 * Esta grabación sirvió de GUÍA para crear:
 * → tests/casos-prueba/02-registrar-sancion.spec.ts ✅
 * 
 * Problemas de esta grabación:
 * - Tiene valores hardcodeados
 * - Sin randomización
 * - Selectors genéricos (#pn_id_135, etc)
 * - Sin manejo robusto de esperas
 */
